...
public class WSConnection {
    public static final Logger logger = LogManager.getLogger("clientcore/websocket");
     ...
     *
     * @throws Exception throws an exception for clientcore.websocket connections
     */
    ...
    /**
     * Terminates the clientcore.websocket connection, and sets the system to the CLOSE state.
     */
    public void close() {
    ...
    /**
     * Called when clientcore.websocket has been closed. Will attempt to reconnect if previous state is not CLOSE.
     ...
     *
     * @param statusCode Status code of closed clientcore.websocket
     * @param reason     Reason that clientcore.websocket was closed.
     */
    @SuppressWarnings("WeakerAccess")
    @OnWebSocketClose
    ...
    /**
     * Sends the message through the clientcore.websocket. Will exit without doing anything if state is CLOSE or EXIT.
     *
